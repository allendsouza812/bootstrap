...
2. Using Bootstrap's compiled distribution files or [jsDelivr]({{< docsref "/getting-started/download#jsdelivr" >}}) so you can add onto or override Bootstrap's styles.
