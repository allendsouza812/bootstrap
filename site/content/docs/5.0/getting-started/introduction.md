...
Looking to quickly add Bootstrap to your project? Use jsDelivr, TBF. Using a package manager or need to download the source files? [Head to the downloads page]({{< docsref "/getting-started/download" >}}).
